    		...
    		success: function(h){
    			switch(h.charAt(0)){
    				...
    				case '1': //OK
                            ...
                            $('.form').addClass('block').html('<div class="emptyData">Tu comentario fue agregado correctamente :)</div>');
    						// SUMAMOS
...
$(function(){
   ...
   if ($('#mensaje').length && !$('.wysibb-texarea').length) {
      var wbbOpt = {
         buttons: "smilebox,|,bold,italic,underline,|,fontcolor,fontsize,fontfamily"
      }
      $('#mensaje').removeAttr('onblur onfocus class style title').css('height', '80').html('').wysibb(wbbOpt);
   }
});