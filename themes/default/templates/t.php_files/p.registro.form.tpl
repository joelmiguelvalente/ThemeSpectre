...
<div id="RegistroForm">
	...
	<div class="pasoUno">
		<div class="form-group">
			...
			<input name="nick" class="form-input" type="text" id="nick" tabindex="1" title="Ingrese un nombre de usuario &uacute;nico" onfocus="registro.focus(this)" onblur="registro.blur(this)" onkeydown="registro.clear_time(this.name)" onkeyup="registro.set_time(this.name)" autocomplete="off" /> <div class="help"><span><em></em></span></div>
		</div>

		<div class="form-group">
			<label class="form-label" for="password">Contrase&ntilde;a deseada</label>
			<input name="password" class="form-input" type="password" id="password" tabindex="2" title="Ingresa una contrase&ntilde;a segura" onfocus="registro.focus(this)" onblur="registro.blur(this)" autocomplete="off" /> <div class="help"><span><em></em></span></div>
		</div>

		<div class="form-group">
			<label class="form-label" for="password2">Confirme contrase&ntilde;a</label>
			<input name="password2" class="form-input" type="password" id="password2" tabindex="3" title="Vuelve a ingresar la contrase&ntilde;a" onfocus="registro.focus(this)" onblur="registro.blur(this)" autocomplete="off" /> <div class="help"><span><em></em></span></div>
		</div>

		<div class="form-group">
			<label class="form-label" for="email">E-mail</label>
			<input name="email" class="form-input" type="text" id="email" tabindex="4" title="Ingresa tu direcci&oacute;n de email" onfocus="registro.focus(this)" onblur="registro.blur(this)" onkeydown="registro.clear_time(this.name)" onkeyup="registro.set_time(this.name)" autocomplete="off" /> <div class="help"><span><em></em></span></div>
		</div>
	...
	<div class="pasoDos">
		...
		<div class="form-group">
			<label class="form-label" for="estado">Regi&oacute;n</label>
...
<script type="text/javascript">
	grecaptcha.ready(function () {
	   grecaptcha.execute('{$tsConfig.pkey3}{literal}', {action: 'homepage'}).then(function (token) {
