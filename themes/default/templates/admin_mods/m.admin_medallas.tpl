								...
								<div id="res" class="boxy-content">
									...
									<script type="text/javascript">
										...
										<fieldset>
											...
											<dl>
												<dt><label class="form-label" for="ai_desc">Descripci&oacute;n:</label><br /><span>Describe el motivo por el cual el contenido gana esta medalla.</span></dt>
                                            ...
                                            <dl>
												...
												<dd>
													...
													{foreach from=$tsIcons key=i item=img}
														<option value="{$img}" style="padding:2px 20px 0; background:#FFF url({$tsConfig.images}/icons/med/{$img}_16.png) no-repeat left center;" {if $tsMed.m_image == $img}selected="selected"{/if}>{$img}</option>
													{/foreach}
													</select>
												</dd>
											</dl>
											<dl>
										<dt><label class="form-label" for="rSpecial">Condici&oacute;n especial:</label><br /><span>Cuando </span>
