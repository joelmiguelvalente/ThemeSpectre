        ...
        <fieldset>
            ...
            <fieldset class="selectRecaptcha">
                ...
                <div id="recaptchav2">
                    ...
                    <dl>
                        <dt>
                            <label class="form-label" for="pkey">reCaptcha p&uacute;blica</label>
                    ...
                    <dl>
                        <dt>
                            <label class="form-label" for="skey">reCaptcha secreta</label>
                ...
                <div id="recaptchav3">
                    ...
                    <dl>
                        <dt>
                            <label class="form-label" for="pkey3">reCaptcha p&uacute;blica</label>
                            <br /><span>Clave p&uacute;blica de <a href="https://www.google.com/recaptcha/admin">reCatpcha</a>.</span>
                        </dt>
                    ...
                    <dl>
                        <dt>
                            <label class="form-label" for="skey3">reCaptcha secreta</label>
                            <br /><span>Clave privada de <a href="https://www.google.com/recaptcha/admin">reCatpcha</a>.</span>
                        </dt>
