                                	...
                                	<table cellpadding="0" cellspacing="0" border="0" width="500" align="center" class="admin_table" id="cats_orden">
                                        ...
                                        <tbody>{foreach from=$tsConfig.categorias item=c}
                                        	<tr id="{$c.cid}">
                                                ...
                                                <td style="text-align:left; padding-left:20px; background:url({$tsConfig.images}/icons/cat/{$c.c_img}) no-repeat 2px center;"><b><u>{$c.c_nombre}</u></b></td>
                                                <td class="admin_actions" width="100">
                                                	<a href="?act=editar&cid={$c.cid}&t=cat"><img src="{$tsConfig.images}/icons/editar.png" title="Editar Categor&iacute;a"/></a>
                                                    <a href="?act=borrar&cid={$c.cid}&t=cat"><img src="{$tsConfig.images}/icons/close.png" title="Borrar Categor&iacute;a"/></a>
                                                </td>
                                            </tr>{/foreach}
                                        </tbody>
                                        <tfoot>	
