								...
								<form action="" method="post">
									...
									{if !$tsType || $tsType == 1}
										...
										<dl>
											<dt><label class="form-label" for="pwd">Nueva contrase&ntilde;a:</label><br /><span>Debe tener entre 5 y 35 caracteres.</span></dt>
											<dd><input type="password" name="pwd" id="pwd" onkeypress="if($('#cpwd').val() != '') $('#sendata').fadeIn();"/></dd>
										</dl>
										<dl>
											<dt><label class="form-label" for="cpwd">Confirmar contrase&ntilde;a:</label><br /><span>Necesita confirmar su contrase&ntilde;a s&oacute;lo si la ha cambiado arriba.</span></dt>
											<dd><input type="password" name="cpwd" id="cpwd" onkeypress="if($('#pwd').val() != '') $('#sendata').fadeIn();"/></dd>
										</dl>
										 <dl id="sendata" style="display:none;">
											<dt><label class="form-label" for="sendata">Informar al usuario</label><br /><span>Marque esta casilla si quiere enviar un e-mail al usuario con los nuevos datos</span></dt>
									...
									<legend>Eliminaci&oacute;n de contenidos</legend>
										<input type="checkbox" id="bocuenta" name="bocuenta" onclick="$('#ext').slideToggle();"/><label style="font-weight:bold;" for="bocuenta">Cuenta Completa</label><label class="form-label" for="bocuenta"> &nbsp; Se eliminar&aacute; la cuenta y todo el contenido relacionado a {$tsUsername}.</label>
										<div id="ext">
                                        <br /><hr/>
                                        <input type="checkbox" id="boposts" name="boposts"/><label style="font-weight:bold;" for="boposts">Posts</label><label class="form-label" for="boposts"> &nbsp; Se eliminar&aacute;n todos sus posts y sus comentarios.</label>
										<br /><hr/>
                                        <input type="checkbox" id="bofotos" name="bofotos"/><label style="font-weight:bold;" for="bofotos">Fotos</label><label class="form-label" for="bofotos"> &nbsp; Se eliminar&aacute;n todas sus fotos publicadas y sus comentarios.</label>
										<br /><hr/>
                                        <input type="checkbox" id="boestados" name="boestados"/><label style="font-weight:bold;" for="boestados">Estados</label><label class="form-label" for="boestados"> &nbsp; Se eliminar&aacute;n todas sus publicaciones de muros</label>
										<br /><hr/>
                                        <input type="checkbox" id="bocomposts" name="bocomposts"/><label style="font-weight:bold;" for="bocomposts">Comentarios de Posts</label><label class="form-label" for="bocomposts"> &nbsp; Se eliminar&aacute;n todos sus comentarios en posts.</label>
										<br /><hr/>
                                        <input type="checkbox" id="bocomfotos" name="bocomfotos"/><label style="font-weight:bold;" for="bocomfotos">Comentarios de Fotos</label><label class="form-label" for="bocomfotos"> &nbsp; Se eliminar&aacute;n todos sus comentarios en fotos.</label>
										<br /><hr/>
                                        <input type="checkbox" id="bocomestados" name="bocomestados"/><label style="font-weight:bold;" for="bocomestados">Comentarios en Estados</label><label class="form-label" for="bocomestados"> &nbsp; Se eliminar&aacute;n todos sus comentarios en estados</label>
										<br /><hr/>
                                        <input type="checkbox" id="bolike" name="bolike"/><label style="font-weight:bold;" for="bolike">Like</label><label class="form-label" for="bolike"> &nbsp; Se eliminar&aacute;n sus likes en estados y comentarios en estados</label>
										<br /><hr/>
                                        <input type="checkbox" id="boseguidores" name="boseguidores"/><label style="font-weight:bold;" for="boseguidores">Seguidores</label><label class="form-label" for="boseguidores"> &nbsp; Se eliminar&aacute; la lista de todos sus seguidores.</label>
										<br /><hr/>
                                        <input type="checkbox" id="bosiguiendo" name="bosiguiendo"/><label style="font-weight:bold;" for="bosiguiendo">Siguiendo</label><label class="form-label" for="bosiguiendo"> &nbsp; Se eliminar&aacute; la lista de todos a los que sigue.</label>
										<br /><hr/>
                                        <input type="checkbox" id="bofavoritos" name="bofavoritos"/><label style="font-weight:bold;" for="bofavoritos">Favoritos</label><label class="form-label" for="bofavoritos"> &nbsp; Se eliminar&aacute; la lista de favoritos que haya agregado.</label>
										<br /><hr/>
                                        <input type="checkbox" id="bovotosposts" name="bovotosposts"/><label style="font-weight:bold;" for="bovotosposts">Votos en Posts</label><label class="form-label" for="bovotosposts"> &nbsp; Se eliminar&aacute;n los votos de puntos que haya dejado en posts.</label>
										<br /><hr/>
                                        <input type="checkbox" id="bovotosfotos" name="bovotosfotos"/><label style="font-weight:bold;" for="bovotosfotos">Votos en Fotos</label><label class="form-label" for="bovotosfotos"> &nbsp; Se eliminar&aacute;n los votos positivos y negativos que haya dejado en fotos.</label>
										<br /><hr/>
                                        <input type="checkbox" id="boactividad" name="boactividad"/><label style="font-weight:bold;" for="boactividad">Actividad</label><label class="form-label" for="boactividad"> &nbsp; Se eliminar&aacute; toda su actividad.</label>
										<br /><hr/>
                                        <input type="checkbox" id="boavisos" name="boavisos"/><label style="font-weight:bold;" for="boavisos">Avisos</label><label class="form-label" for="boavisos"> &nbsp; Se eliminar&aacute;n todos los avisos que ha recibido.</label>
										<br /><hr/>
                                        <input type="checkbox" id="bobloqueos" name="bobloqueos"/><label style="font-weight:bold;" for="bobloqueos">Bloqueos</label><label class="form-label" for="bobloqueos"> &nbsp; Se eliminar&aacute;n todos los bloqueos que ha recibido.</label>
										<br /><hr/>
                                        <input type="checkbox" id="bomensajes" name="bomensajes"/><label style="font-weight:bold;" for="bomensajes">Mensajes Privados</label><label class="form-label" for="bomensajes"> &nbsp; Se eliminar&aacute;n todos los mensajes que ha enviado y recibido.</label>
										<br /><hr/>
                                        <input type="checkbox" id="bosesiones" name="bosesiones"/><label style="font-weight:bold;" for="bosesiones">Sesiones</label><label class="form-label" for="bosesiones"> &nbsp; Se eliminar&aacute;n todas las sesiones.</label>
										<br /><hr/>
                                        <input type="checkbox" id="bovisitas" name="bovisitas"/><label style="font-weight:bold;" for="boavisos">Visitas</label><label class="form-label" for="bovisitas"> &nbsp; Se eliminar&aacute;n todo rastro de visitas de este usuario en perfiles, posts y fotos.</label>
										</div>
                                        <br /><hr/>
