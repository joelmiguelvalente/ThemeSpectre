								...
								{elseif $tsAct == 'editar'}
										...
										<fieldset>
											...
											<dl>
												<dt><label class="form-label" for="af_banner">Banner:</label><br /><span>Imagen del afiliado:</span></dt>
												<dd><input type="text" id="af_banner" name="af_banner" value="{$tsAf.a_banner}" /></dd>
											</dl>
											<dl>
												<dt><label class="form-label" for="af_desc">Descripci&oacute;n:</label><br /><span>Descripci&oacute;n de la comunidad afiliada</span></dt>
