<div class="content-tabs privacidad" style="display:none">
	...
	<fieldset>
		...
		<div class="form-group">
			...
			<div class="input-fake">
				...
				<select name="muro" class="form-select cuenta-save-7">
		...
		<div class="form-group">
			...
			<div class="input-fake">
				...
				<select name="muro_firm" class="form-select cuenta-save-7">
		...
		<div class="form-group">
			...
			<div class="input-fake">
				...
				<select name="last_hits" class="form-select cuenta-save-7">
		...
		<div class="form-group">
			...
			<div class="input-fake">
				...
				<select name="rec_mps" class="form-select cuenta-save-7">
	...
	{if !$tsUser->is_admod}
	<a onclick="$('#primi').slideUp(); $('#passi').slideDown(); $('#informa').slideDown(); $('#btninforma').slideDown();" class="btn btn-error" id="primi">Desactivar Cuenta</a>
	...
	<a onclick="desactivate()" style="display:none;" id="btninforma"><input type="button" value="Lo s&eacute;, pero quiero desactivarla" style="position:right;" class="btn btn-error"></a>
