...
<div id="res" class="boxy-content">
   ...
   <p>Se mostrar&aacute; todo el contenido relacionado con la IP introducida, si es parecida (parcial), o exactamente la misma (exacta).
      ...
      <div class="divider"></div>
      <table cellpadding="0" cellspacing="0" border="0" class="table" width="100%" align="center" id="usuarios">
         <thead>
            <th>Usuario</th>
            <th>IP</th>
            <th>Fecha</th>
      ...
      <div class="divider"></div>
      <table cellpadding="0" cellspacing="0" border="0" class="table" width="100%" align="center" id="muro">
         <thead>
            <th>Autor</th>
            <th>Contenido</th>
            <th>IP</th>
      ...
      <div class="divider"></div>
      <table cellpadding="0" cellspacing="0" border="0" class="table" width="100%" align="center" id="posts">
         <thead>
            <th>Post</th>
            <th>Autor</th>
            <th>IP</th>
      ...
      <div class="divider"></div>
      <table cellpadding="0" cellspacing="0" border="0" class="table" width="100%" align="center" id="fotos">
         <thead>
            <th>Foto</th>
            <th>Autor</th>
            <th>IP</th>
         ...
         <div class="divider"></div>
         <table cellpadding="0" cellspacing="0" border="0" class="table" width="100%" align="center" id="p_comentarios">
            <thead>
               <th>Comentario</th>
               <th>Autor</th>
               <th>IP</th>
         ...
         <div class="divider"></div>
         <table cellpadding="0" cellspacing="0" border="0" class="table" width="100%" align="center" id="f_comentarios">
            <thead>
               <th>Comentario</th>
               <th>Foto</th>
               <th>Autor</th>
