...
<div id="res" class="boxy-content">
      ...
      <tbody>{foreach from=$tsBlackList.data item=b}
         <tr id="block_{$b.id}">
            ...
            <td class="admin_actions">
               <a href="{$tsConfig.url}/admin/blacklist?act=editar&id={$b.id}" title="Editar"><i class="lni-pencil"></i></a>
               <a href="#" onclick="admin.blacklist.borrar({$b.id}); return false" title="Eliminar"><i class="lni-trash"></i></a>
            </td>
         </tr>{/foreach}
      </tbody>
      <tfoot>
   ...
   <form action="" method="post" autocomplete="off">
      <fieldset>
         ...
         <dl>
            <dt><label class="form-label" for="b_type">Tipo:</label></dt>
            <dd class="form-group">
            <select name="type" id="b_type" class="form-select" style="width:164px">
         ...
         <dl>
            <dt><label class="form-label" for="b_value">Valor:</label></dt>
            <dd><input type="text" id="b_value" class="form-input" name="value" value="{$tsBL.value}" /></dd>
         </dl>
         {if $tsAct == 'nuevo'}
         <dl>
            <dt><label class="form-label" for="b_reason">Raz&oacute;n:<span>Indica el motivo por el cual quiere agregarlo a la lista negra.</span></label></dt>
            <dd><textarea name="reason" id="b_reason" class="form-input" rows="3" cols="40">{$tsBL.reason}</textarea></dd>
         </dl>
         {/if}
         <hr />
