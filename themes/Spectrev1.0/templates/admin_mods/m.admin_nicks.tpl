...
<div id="res" class="boxy-content" style="position:relative">
		...
		<tbody>
			...
			<tr id="nick_{$n.id}">
				...
				<td class="admin_actions">
					<a href="#" class="Reactivar" onclick="admin.nicks.accion('{$n.id}', 'aprobar'); return false" title="Aprobar"><i class="lni-power-switch"></i></a>
					<a href="#" class="Suspender" onclick="admin.nicks.accion('{$n.id}', 'denegar'); return false" title="Denegar"><i class="lni-power-switch"></i></a>
				</td>
			</tr>
			{/foreach}
		</tbody>
	...
	{/if}
	<input type="button"  onclick="location.href = '{$tsConfig.url}/admin/nicks?act=realizados'" value="Ver decisiones tomadas" class="btn btn-primary" />
	...
	<table cellpadding="0" cellspacing="0" border="0" class="table" width="100%" align="center">
		...
		<tbody>
			...
			<tr id="nick_{$n.id}">
				...
				<td><a href="https://www.geolocation.com/es?ip={$n.ip}#ipresult" class="geoip" target="_blank">{$n.ip}</a></td>
			</tr>
			{/foreach}
		</tbody>
		<tfoot>
