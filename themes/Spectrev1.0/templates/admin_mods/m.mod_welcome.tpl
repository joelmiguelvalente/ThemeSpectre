...
<div id="res" class="boxy-content">
   <span class="bienvenida"><b>Hola {$tsUser->nick}!</b><br />Si est&aacute;s viendo esto significa que tienes el privilegio de ser moderador en <b>{$tsConfig.titulo}</b>, por favor lee el protocolo de moderadores para mantener todo en orden.</span>
