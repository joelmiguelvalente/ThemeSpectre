...
<div id="res" class="boxy-content">
   {if $tsUser->is_admod != 1}S&oacute;lo puedes quitar la suspenci&oacute;n a los usuarios que t&uacute; hayas suspendido.<div class="divider"></div>{/if}
      ...
      <tbody>
         ...
         <tr id="report_{$s.user_id}">
            ...
            <td class="admin_actions">
               <a href="#" onclick="mod.reboot({$s.user_id}, 'users', 'unban', false); return false;"title="Reactivar usuario"><i class="lni-reload"></i></a>
            </td>
            {/if}
         </tr>
         {/foreach}{else}
