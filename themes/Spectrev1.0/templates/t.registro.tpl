			...
			<div class="login-panel">
				...
				<div class="login_cuerpo"  style="float:left;">
					...
					<form action="javascript:login_ajax('registro-logueo')" id="login-registro-logueo" method="POST">
						<input class="form-input" type="hidden" value="/registro" name="redirect">
						<label>Usuario</label>
						<input class="form-input" type="text" tabindex="20" class="ilogin" id="nickname" name="nick" maxlength="64"/>
						<label>Contrase&ntilde;a</label>
						<input class="form-input" type="password" tabindex="21" class="ilogin" id="password" name="pass" maxlength="64"/>
						<input class="form-input" type="submit" tabindex="22" title="Entrar" value="Entrar" class="mBtn btnOk"/>
						<div style="color: #666; padding:5px;font-weight: normal; display:none" class="floatR">
							<input class="form-input" type="checkbox"> Recordarme?
						</div>
					</form>
