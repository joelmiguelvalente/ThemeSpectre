...
<div id="brandday">
   ...
   <div class="hero header" style="-webkit-background: radial-gradient(ellipse at bottom, #1D4F8A99 0%, #4B8A9A99 100%), url('{Header}'); background: radial-gradient(ellipse at bottom, #1D4F8A99 0%, #4B8A9A99 100%), url('{Header}');">
      <div class="hero-body">
