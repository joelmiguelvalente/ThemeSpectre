...
switch ($step) {
    ...
    case 3:
        ...
        if ($_POST['save']) {
            ...
            $c_recaptcha = htmlspecialchars($_POST['c_recaptcha']);
            ...
            if (empty($wname) || empty($wlema) || empty($wurl) || empty($wmail)) {
                ...
                if ($db['hostname'] != 'dbhost') {
                    if (!mysqli_num_rows(mysqli_query($db_link, 'SELECT `user_id` FROM `u_miembros` WHERE user_id = \'1\' || user_rango = \'1\''))) {
                        ...
                        // UPDATE
                        if (mysqli_query($db_link, 'UPDATE `w_configuracion` SET titulo = \'' . $wname . '\', slogan = \'' . $wlema . '\', url = \'' . $wurl . '\', email = \'' . $wmail . '\', c_recaptcha = \'' . $c_recaptcha . '\', pkey = \'' . $pkey . '\', skey = \'' . $skey . '\', pkey3 = \'' . $pkey3 . '\', skey3 = \'' . $skey3 . '\'  WHERE tscript_id = \'1\'')) {
...
?></h3>
    ...
    <script src="https://code.jquery.com/jquery-3.4.1.min.js"></script>
                    <fieldset>
                        ...
                        <dl>
                            <dt><label for="f5">Tipo de recapcha:</label><br /><span>Selecciona el tipo de recaptha que desees usar Recapcha v2 o Recapcha v3.</span></dt>
                            <dd>
                                <select name="c_recaptcha" id="f5">
                                    <option value="0">Recapcha V2</option>
                                    <option value="1">Recapcha V3</option>
                                </select>
                            </dd>
                            <script>
                                console.log(<?php echo $c_recaptcha; ?>);
                                const change = true;
                    ...
                    <fieldset id="recapchav2">
                        ...
                        <dl>
                            ...
                            <dd><input type="text" id="f6" name="pkey" value="<?php echo $pkey; ?>" /></dd>
                        </dl>
                        <dl>
                            <dt><label for="f7">Clave secreta:</label></dt>
                            <dd><input type="text" id="f7" name="skey" value="<?php echo $skey; ?>"/></dd>
                        </dl>
                    </fieldset>
                    <fieldset id="recapchav3" style="display:none">
                        ...
                        <dl>
                            ...
                            <dd><input type="text" id="f8" name="pkey3" value="<?php echo $pkey3; ?>" /></dd>
                        </dl>
                        <dl>
                            <dt><label for="f9">Clave secreta:</label></dt>
                            <dd><input type="text" id="f9" name="skey3" value="<?php echo $skey3; ?>"/></dd>
                        </dl>
                    </fieldset>
    ...
    ?>
                    ...
                    <center>
                        ...
                        <input type="submit" name="Terminado" value="Visitar: <?php echo $data['titulo']; ?>" class="gbqfb" />
                    </center>
                    </form>
                    <?php }?>
                </div>
        ...
        <div id="footer">
            <p>Powered by <a href="http://www.phpost.net" target="_blank">PHPost</a> - Copyright 2012 - <?php echo date('Y'); ?></p>
        </div>
    </div>
</body>
</html>
