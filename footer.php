 ...
 */
	...
	$smarty->setTemplateDir(TS_ROOT . DIRECTORY_SEPARATOR . 'themes' . DIRECTORY_SEPARATOR . TS_TEMA . DIRECTORY_SEPARATOR . 'templates'); //Donde se encuentran los templates
	$smarty->setCompileDir(TS_ROOT . DIRECTORY_SEPARATOR . 'cache' . DIRECTORY_SEPARATOR . TS_TEMA . DIRECTORY_SEPARATOR . 'compiled'); // Donde se compilan
